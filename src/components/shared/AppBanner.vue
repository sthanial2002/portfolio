	...
	>
		...
		<div class="w-full md:w-1/3 text-left">
			...
			<div class="flex justify-center sm:block">
				<a
					download="Sthanial_CV.pdf"
					href="https://drive.google.com/file/d/1LMosBORIing5iNlw_Frx9Nm3r2a6MqSQ/view?usp=sharing"
		...
		<div class="w-full md:w-2/3 text-right float-right">
			<img
				v-if="theme === 'light'"
				src="https://res.cloudinary.com/sthanial2002/image/upload/v1657248841/portfolio/developer-dark_yr9hox.svg"
				alt="Developer"
			/>
			<img
				v-else
